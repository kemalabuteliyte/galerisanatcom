...
export const galleries: Gallery[] = [
  {
    id: '1',
    name: 'Çağdaş Dijital Galeri',
    description: 'Yeni yetişen ve köklü sanatçıların en iyi dijital sanat eserlerini sergiliyor. Galerimiz dijital yaratıcılığın sınırlarını zorlamaya odaklanıyor.',
  ...
  {
    id: '2',
    name: 'Modern Heykel Pavyonu',
    description: 'Geleneksel ve dijital ortamları birleştiren çağdaş heykele adanmış bir alan.',
